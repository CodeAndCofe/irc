...
/*   Updated: 2025/12/10 15:33:20 by amandour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//Errors :
#define ERR_NICKINUSE(target)						        PREFIX "433 " + target + " :Nickname is already in use " POSTFIX 
#define ERR_MISSINGPARAMS(command)						        PREFIX "461 " + command + " :Not enough parameters " POSTFIX  
#define ERR_INVALIDCOMMAND(client, command)						PREFIX "421 " + client + " " + command + " :Unknown command " POSTFIX 
#define ERR_NOTCHANOP(channel)					        PREFIX "482 " + channel + " :You're not channel operator" POSTFIX
#define ERR_INVALIDNICK(nick)						        PREFIX "432 " + nick + " :Erroneus nickname " POSTFIX 
#define ERR_INVALIDUSER(nick)						                PREFIX "432 " + user + " :Erroneus user " POSTFIX 
#define ERR_NOMESSAGE()								        PREFIX "412 :No text to send" POSTFIX 
#define ERR_CHANNELNOTFOUND(channel)						        PREFIX "403 " + channel + " :No such channel " POSTFIX 
...
//Replays :
#define RPL_CONNECT(sender, msg)               			        PREFIX "001 " + sender + " : " + msg + POSTFIX 
#define RPL_NAMES(sender, channel, users)    		        PREFIX "353 " + sender + " = " + channel + " :" + users + POSTFIX
#define RPL_NAMESEND(sender, channel)        			        PREFIX "366 " + sender + " " + channel + " :End of /NAMES list." POSTFIX
#define RPL_CHTOPIC(sender, channel, topic)				        PREFIX "332 " + sender + " " + channel + " :" + topic + POSTFIX    
...
#define RPL_NEWNICK(sender, nick)							        ":" + sender + " NICK " + nick + POSTFIX
#define RPL_INVITESENT(sender, channel)					        PREFIX " 331 " + sender + " " + channel + " :No topic is set" POSTFIX
...
#define RPL_KICKNOCOMMENT(sender, channel, target)                 ":" + sender + " KICK " + channel + " " + target + POSTFIX